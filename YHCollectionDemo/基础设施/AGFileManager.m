...
+(NSMutableArray *)absoluteDirectories
{
    ...
    dispatch_once(&token, ^{
        ...
        [directories sortUsingComparator:^NSComparisonResult(id obj1, id obj2) {
            ...
            return (NSComparisonResult)((((NSString *)obj1).length > ((NSString *)obj2).length) ? 0 : 1);
...
{
    return [[AGFileManager pathForApplicationSupportDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[AGFileManager pathForCachesDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[AGFileManager pathForDocumentsDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[AGFileManager pathForLibraryDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[AGFileManager pathForMainBundleDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[AGFileManager pathForTemporaryDirectory] stringByAppendingPathComponent:path];
}
